...
const EditUser = () => {
  ...
  const displayImageUrl = imageFile ? URL.createObjectURL(imageFile) : currentImageUrl || 'https://via.placeholder.com/150';

  return (
    <div className="p-5 font-sans rtl text-right bg-gray-50 min-h-screen">
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">تعديل مستخدم: {formData.username}</h2>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="col-span-1 md:col-span-2 flex flex-col items-center">
            ...
            {currentImageUrl && (
              <button
                ...
                className="mt-2 bg-red-500 text-white rounded-md px-4 py-2 hover:bg-red-600 transition-colors text-sm"
              >
                حذف الصورة الحالية
              </button>
            )}
          ...
          <div className="md:col-span-2 flex justify-end gap-3 mt-6">
            <button
              ...
              className="bg-gray-300 text-gray-800 rounded-md px-6 py-3 hover:bg-gray-400 transition-colors"
            >
              إلغاء
            </button>
            <button
              type="submit"
              className="bg-blue-600 text-white rounded-md px-6 py-3 hover:bg-blue-700 transition-colors shadow-lg"
              disabled={submitting}
            >
