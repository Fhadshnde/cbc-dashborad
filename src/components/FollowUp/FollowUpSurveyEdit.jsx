...
const FollowUpSurveyEdit = () => {
  ...
  if (!formData) return <p className="text-center mt-10">جارٍ تحميل البيانات...</p>;

  return (
    <div className="p-6 max-w-3xl mx-auto">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">تعديل استبيان المتابعة</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-between pt-6">
          ...
          {step < 4 ? (
            ...
            <button type="submit" className="bg-yellow-600 text-white px-4 py-2 rounded-lg">حفظ التعديلات</button>
          )}
        </div>
      </form>
    </div>
